...
module.exports = function (o) {
  var useLog = o.options.logging && !typr.isFunction(o.target)
    , persist = persister(o.options.persist, [o.target, o.libsOnlyTarget], log.get('debug'))
    , ns = o.options.namespace
    , dw = o.options.domloader
    , before = o.pre.length > 0 ? $.seq.apply({}, o.pre) : id
    , after = o.post.length > 0 ? $.seq.apply({}, o.post) : id
    , compile = makeCompiler(o.compilers)
    , forceUpdate = o.options.force || persist.objectModified(o);

  // deleting output should force re-compile
  forceUpdate |= !typr.isFunction(o.target) && !exists(o.target);

  if (!typr.isFunction(dw)) { // special domloader string need to be converted to fn
  ...
  if (o.treeTarget) {
    ...
    if (typr.isFunction(o.treeTarget)) {
      o.treeTarget(tree);
    } else {
  ...
  if (o.target) {
    ...
    // persist ultimately uses dom::relFilePath as a key, and it always needs to..
    // cant generalize it much
    ...
    if (o.libDir && o.libFiles) {
      ...
      var forceUpdateLibs = !typr.isFunction(o.libsOnlyTarget) && !exists(o.libsOnlyTarget);

      if (o.libsOnlyTarget && (libsUpdated || forceUpdateLibs) && !typr.isFunction(o.libsOnlyTarget)) {
        fs.writeFileSync(o.libsOnlyTarget, libs);
        log.info('compiling separate libs');
        libsUpdated = false;
      }
      else if (typr.isFunction(o.libsOnlyTarget)) {
