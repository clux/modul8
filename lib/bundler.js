...
function bundleApp(codeList, ns, domload, compile, before, npmTree, o) {
  ...
  // 6. filter function splits code into app and non-app code and defineWraps
  ...
  //l.push("\n// node builtins\n"); //TODO: write this line iff _builtIns contain non-path elements
  npmTree._builtIns.forEach(function (b) {
  ...
  l.push("\n// shared code\n"); //TODO: only write this line if there is shared code
