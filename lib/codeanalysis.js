(function() {
  ...
  formatName = function(name, hideExt, withDom, dom) {
    var n;
    n = hideExt ? name.split('.')[0] : name;
    if (withDom) {
      n = dom + '::' + n;
    }
    return n;
  };
  CodeAnalysis.prototype.printed = function(hideExts, showDomain) {
    var lines;
    lines = [formatName(this.basePoint, hideExts, showDomain, 'client')];
  ...
  module.exports = function(basePoint, domains, useLocalTests) {
    ...
    return {
      printed: function(extSuffix, domPrefix) {
        if (extSuffix == null) {
          extSuffix = false;
        }
        if (domPrefix == null) {
        ...
        return o.printed.call(o, extSuffix, domPrefix);
      },
      sorted: function() {
