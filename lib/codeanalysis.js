(function() {
  ...
  CodeAnalysis = function(basePoint, domains, mainDomain, useLocalTests) {
  ...
  CodeAnalysis.prototype.printed = function(extSuffix, domPrefix) {
    ...
    lines = [formatName(this.basePoint, extSuffix, domPrefix, this.mainDomain)];
  ...
  CodeAnalysis.prototype.sorted = function() {
    var ary, name, obj;
    obj = {};
    obj[this.basePoint] = [0, this.mainDomain];
    (function(t) {
      var dep, name, _ref2;
      _ref2 = t.deps;
      for (name in _ref2) {
  ...
  module.exports = function(basePoint, domains, mainDomain, useLocalTests) {
    var o;
    ...
    if (!domains || !domains[mainDomain]) {
      throw new Error("brownie code analysis: domains needed, and needs to contain specified mainDomain " + mainDomain + ". Got " + domains);
    }
