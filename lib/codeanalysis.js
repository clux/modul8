(function() {
  ...
  _ref = require('./utils'), compile = _ref.compile, objCount = _ref.objCount, exists = _ref.exists;
  ...
  CodeAnalysis.prototype.resolveRequire = function(absReq, domain, wasRelative) {
    var dom, name, scannable, _i, _len;
    scannable = wasRelative ? [domain] : [domain].concat((function() {
  ...
  CodeAnalysis.prototype.sanitizedTree = function() {
    var m;
    m = {};
    (function(treePos, mPos) {
      var dep;
      for (dep in treePos.deps) {
        arguments.callee(treePos.deps[dep], mPos[dep] = {});
      }
  ...
  CodeAnalysis.prototype.sorted = function() {
    ...
    (function(treePos) {
      ...
      for (name in _ref2) {
        ...
        obj[name][0] = Math.max(dep.level, obj[name][0] || 0);
