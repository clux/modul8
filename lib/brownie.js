(function() {
  var anonWrap, bundle, codeAnalyis, compile, exists, fs, jQueryWrap, minify, objCount, parser, path, pullData, uglify, _ref, _ref2;
  fs = require('fs');
  path = require('path');
  codeAnalyis = require('./codeanalysis');
  _ref = require('./utils'), compile = _ref.compile, exists = _ref.exists, anonWrap = _ref.anonWrap, jQueryWrap = _ref.jQueryWrap, objCount = _ref.objCount;
  ...
  exports.bake = function(i) {
    var c, ca, clientDom, file, hasData, libs, name, _i, _j, _len, _len2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
    if (!i.domains) {
    ...
    if (i.treeTarget) {
      fs.writeFileSync(i.treeTarget, ca.print());
    }
    if (i.logTree) {
      return console.log(ca.print());
    }
  };
