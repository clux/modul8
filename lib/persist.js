...
// TODO: should only need a fileList, do zipping outside this module!
...
module.exports = function (a, b, c) {
  var p = new Persist(a,b,c);
  return {
    filesModified  : function () {
      return p.filesModified.apply(p, arguments);
    }
  , objectModified : function () {
      return p.objectModified.apply(p, arguments);
    }
  };
};
